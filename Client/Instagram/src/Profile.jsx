...
const Profile = () => {
  ...
  return (
    <div className='w-[100%] min-h-screen border border-[#FFFFFF7A] box-border flex justify-center'>
      <div className='flex gap-[20px] items-center flex-col w-[70%]'>
        <div className='w-[400px] h-[200px] flex justify-between items-center'>
          <div>
            <img src={userProfile.dp} style={{background:"white",width:"150px",borderRadius:"50%"}} alt="" />
          </div>
          <div className='flex flex-col gap-[5px]'>
            <h1>{userProfile.userName}</h1>
            <h2>{userProfile.name}</h2>
            <p><b className='text-white'>{userPosts.length} posts {userProfile.followers.length} followers {userProfile.following.length} following</b></p>
            <h5>BIO</h5>
          </div>
        </div>
        <button className='w-[400px] h-[50px] text-[17px] bg-[#105151]'>Edit Profile</button>
        <div className='w-full h-[200px] flex justify-evenly items-center flex-col'>
          <p><b>Highlights</b></p>
          <div className='flex itmes-center gap-[20px]'>
            <div>
              <img src={user} style={{background:"white",width:"100px",borderRadius:"50%"}} alt="" />
            </div>
            <div>
              <img src={user} style={{background:"white",width:"100px",borderRadius:"50%"}} alt="" />
            </div>
        ...
        <div className='w-[100%] flex flex-col justify-center items-center'>
          {/* <p><b>Posts</b></p> */}
          <Grid3x3 size={30} className='cursor-pointer m-[2px]'/>
          <div className='grid grid-cols-3 w-[100%] gap-[20px]'>
            {
              userPosts.map((a,b)=>{
                return (
                  <div className='w-[100%] h-[300px] border box-border border-[#FFFFFF7A] relative'>
                    <img src={a.imgUrl} alt="" className='w-[100%] h-[100%]'/>
                    {/* <div className='w-[100%] h-[100%] absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2'>
                      <p><b>Likes Comments</b></p>
                    </div> */}
                  </div>
                )
              })
